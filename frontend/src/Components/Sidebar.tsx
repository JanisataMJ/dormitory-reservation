    ...
    <Layout style={{ minHeight: '100vh' }}>
      <Sider trigger={null} collapsible collapsed={collapsed} className="custom-sider">
        ...
        <div className="user-info-container">
          ...
          <div className="id">B6910000          </div>
          <div className="name">นางสาวกานต์รวี นภารัตน์</div>
        </div>
        <Menu
        ...
        >
          <Menu.Item key="Student" onClick={() => handleMenuClick('Student')}>
            นักศึกษา
          </Menu.Item>
          <Menu.Item key="Bmain" onClick={() => handleMenuClick('Bmain')}>
            จองหอพัก
          </Menu.Item>
          <Menu.Item key="List" onClick={() => handleMenuClick('List')}>
            รายชื่อผู้พัก
          </Menu.Item>
